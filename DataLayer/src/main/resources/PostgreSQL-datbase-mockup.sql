...
--Todos
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed, group_name) values (1, 2, 'morbi non', 'Nulla mollis molestie lorem. Quisque ut erat. Curabitur gravida nisi at nibh.', '1642932539000', '1649375492000', true, 'hac');
...
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed, group_name) values (4, 1, 'diam neque vestibulum eget', 'Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.', '1642866527000', '1648225360000', false, 'turpis a pede');
...
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed, group_name) values (9, 7, 'praesent id', 'Maecenas pulvinar lobortis est. Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum. Proin eu mi.', '1642242271000', '1649874173000', false, 'sapien');
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed, group_name) values (10, 3, 'in eleifend', 'Etiam pretium iaculis justo. In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', '1643162631000', '1648516671000', false, 'metus aenean fermentum donec ut');
...
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed) values (16, 3, 'rhoncus mauris enim leo', 'In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin interdum mauris non ligula pellentesque ultrices.', '1642056836000', '1649744735000', true);
...
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed) values (18, 4, 'accumsan tortor', 'In congue. Etiam justo. Etiam pretium iaculis justo.', '1644245939000', '1645542717000', false);
...
insert into todos (td_id, user_id, todo_name, todo_description, from_time, to_time, completed) values (20, 1, 'eget tempus vel pede', 'Aenean sit amet justo. Morbi ut odio. Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo.', '1643287652000', '1648286156000', false);
